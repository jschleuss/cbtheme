...
<? get_template_part( 'include-view' ); ?>
  ...
  <table id="datatable" class="sortable infinitescroll" width="100%" style="clear:both;">
	  <thead>
	    <tr>
		...
		<?php query_posts(array('category_name' => 'artist', 'orderby' => 'post name', 'order' => 'ASC' )); ?>
			  <?php while (have_posts()) : the_post(); ?>
			    <?php $postmeta = get_post_custom($post->ID); $post_slug = $post->post_name; ?>
			      <tr <?php post_class() ?>>
			    	<td class="thumbnail"><a href="<?php the_permalink(); ?>"><img class="lazy" src="<?php 
  ...
  <div class="clr" style="margin: 0 0 10px 0;"></div>
